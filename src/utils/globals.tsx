...
export const OldTLCStakeContractAddress =
...
//Binance
export const Binance_LSO_SideBridgeContractAddress =
...
export const bridgeAddresses = {
  LSO: {
    ...
    child: {
      ...
      BSC: {
        address: Binance_LSO_SideBridgeContractAddress,
      },
      FTM: {
        address: Fantom_LSO_SideBridgeContractAddress,
      },
      AVAX: {
        address: Avalanche_LSO_SideBridgeContractAddress,
      },
      MATIC: {
        address: Polygon_wLSO_SideBridgeContractAddress,
      },
      ELROND: {
        //sidebridge
        address: '',
  ...
  TLC: {
    ...
    child: {
      ...
      BSC: {
        address: Binance_TLC_SideBridgeContractAddress,
      },
      FTM: {
        address: Fantom_TLC_SideBridgeContractAddress,
      },
      AVAX: {
        address: Avalanche_TLC_SideBridgeContractAddress,
      },
      MATIC: {
        address: Polygon_wTLC_SideBridgeContractAddress,
      },
      ELROND: {
        //sidebridge
...
export const stakingRewards = {
  ...
  TLC: {
    one_month: '2.80% APY - 1 months ',
    three_months: '7.42% APY - 3 months ',
    six_months: '13% APY - 6 months ',
    one_year: '27.10% APY - 12 months ',
    three_years: '69% APY - 36 months ',
  },
  CSY: {
    one_month: '12.19% APY - 1 months ',
    three_months: '17.32% APY - 3 months ',
