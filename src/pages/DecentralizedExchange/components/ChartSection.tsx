...
export const CandleStickChart = (props: any) => {
  ...
  const [dayData, setDayData] = useState([
    ...
    // { time: '2019-05-22 19:30', value: 4.15 },
    // { time: '2019-05-23 11:30', value: 4.18 },
    // { time: '2019-05-24 11:30', value: 4.16 },
    // { time: '2019-05-28 11:30', value: 4.89 },
  ]);
  ...
  useEffect(() => {
    async function fetchData() {
      if (swapTrans) {
        // console.log('swaptrans', swapTrans);
        ...
        const f = new Date();
        const f_date = formatDate(f);
        chartData[chartData.length] = { time: f_date, value: final_ratio };
