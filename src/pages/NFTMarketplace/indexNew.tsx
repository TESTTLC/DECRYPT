  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="grid grid-cols-6">
        ...
        {/* Right Element */}
        <div className="flex flex-col col-span-1 px-4 space-y-6 w-full ">
          {/* First */}
          <div className="w-full rounded-xl bg-black bg-opacity-70 p-4">
            <p className="uppercase text-blue-500 text-sm">Wallet Holders</p>
            <div className="flex items-center justify-center space-x-2">
              <FaWallet size={20} color="cyan" />
          ...
          {/* Second */}
          <div className="w-full rounded-xl bg-black bg-opacity-70 p-4 space-y-8">
