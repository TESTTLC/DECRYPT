...
const TimerBoxComp = (props: ComponentProps) => {
  return (
    <div className="space-y-4">
      <div className="relative h-36 w-36 bg-darkest-blue rounded-lg">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-2 flex items-center justify-center">
          <span className="text-soft-red font-bold text-6xl text-white">
            {props.value}
          </span>
        </div>
      </div>
      ...
      <div className="text-center">
        <span className="uppercase text-sm text-grayish-blue font-bold tracking-4xl text-white">
          {props.label}
        </span>
      </div>
    </div>
